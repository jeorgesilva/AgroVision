...
Image.MAX_IMAGE_PIXELS = 500_000_000  # 500 MP ~ 22 000 x 22 000 px
...
class WeedDetector:
    ...
    def detect(self, source: Any, metadata: Optional[dict] = None) -> dict[str, Any]:
        """
        ...
        return {
            ...
            "metadata": metadata
            or {},  # Passamos os metadados (Transformada Afim) para o resultado
        }
